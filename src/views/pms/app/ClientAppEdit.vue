<template>
  <a-form :form="form">
    ...
    <a-row :gutter="16">
      <a-col :span="12">
        <a-form-item :label-col="formItemLayout.labelCol" :wrapper-col="formItemLayout.wrapperCol"
                     label="secret">
          <!--          <a-input type="password" disabled placeholder="请点击右边生成或查看Secret" />-->
      ...
      <a-col :span="12">
        <a-form-item :label-col="formItemLayout.labelCol" :wrapper-col="formItemLayout.wrapperCol" label="有效日期">
    ...
    <a-row>
      <a-col :span="24">
        <a-form-item :label-col="{span:2}" label="认证模式">
          <!--
    ...
    <a-row :gutter="16">
      ...
      <a-col :span="12">
        <a-form-item :label-col="{span:6}" :wrapper-col="{span:6}"
    ...
    <a-row :gutter="16">
      ...
      <a-col :span="12">
        <a-form-item :label-col="{span:4}" :wrapper-col="{span:8}" label="是否自动认证">
    ...
    <a-row :gutter="16">
      <a-col :span="24">
        <a-form-item :label-col="{span:2}" :wrapper-col="{span:22}" label="状态">
    ...
    <a-row :gutter="16">
      <a-col :span="24">
        <a-form-item :label-col="{span:2}" label="应用头像">
    ...
    <a-row :gutter="16">
      <a-col :span="24">
        <a-form-item :label-col="{span:2}" :wrapper-col="{span: 12}" label="描述">
